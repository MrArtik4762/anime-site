...
// РћР±С‰Р°СЏ С„СѓР½РєС†РёСЏ РІР°Р»РёРґР°С†РёРё
...
const commentSchemas = {
  create: Joi.object({
    ...
    episodeNumber: Joi.number()
      ...
      .min(1)
      .messages({
        'number.integer': 'РќРѕРјРµСЂ СЌРїРёР·РѕРҙР° РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ С†РµР»С‹Рј С‡РёСЃР»РѕРј',
        'number.min': 'РќРѕРјРµСЂ СЌРїРёР·РѕРҙР° РґРѕР»Р¶РµРЅ Р±С‹С‚СЊ Р±РѕР»СЊС€Рµ 0'
      }),
  ...
  updateProgress: Joi.object({
    episodesWatched: Joi.number()
      ...
      .messages({
        ...
        'number.min': 'РљРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРѕСЃРјРѕС‚СЂРµРЅРЅС‹С… СЌРїРёР·РѕРҙРѕРІ РЅРµ РјРѕР¶РµС‚ Р±С‹С‚СЊ РѕС‚СЂРёС†Р°С‚РµР»СЊРЅС‹Рј',
        'any.required': 'РљРѕР»РёС‡РµСЃС‚РІРѕ РїСЂРѕСЃРјРѕС‚СЂРµРЅРЅС‹С… СЌРїРёР·РѕРҙРѕРІ РѕР±СЏР·Р°С‚РµР»СЊРЅРѕ'
      }),
...
const paramSchemas = {
  ...
  animeEpisode: Joi.object({
    ...
    episodeId: Joi.string()
      ...
      .required()
      .messages({
        'string.pattern.base': 'РќРµРІРµСЂРЅС‹Р№ С"РѕСЂРјР°С‚ РЅРѕРјРµСЂР° СЌРїРёР·РѕРҙР°',
        'any.required': 'РќРѕРјРµСЂ СЌРїРёР·РѕРҙР° РѕР±СЏР·Р°С‚РµР»РµРЅ'
      })
  })
};
...
// РЎС…РµРјС‹ РІР°Р»РёРґР°С†РёРё РґР»СЏ РѕС‚СЃР»РµР¶РёРІР°РЅРёСЏ РїСЂРѕРіСЂРµСЃСЃР° РїСЂРѕСЃРњРѕС‚СЂР°
const watchProgressSchemas = {
  saveProgress: Joi.object({
    animeId: Joi.string()
      .pattern(/^[0-9a-fA-F]{24}$/)
      .required()
      .messages({
        'string.pattern.base': 'РќРµРІРµСЂРЅС‹Р№ С"РѕСЂРјР°С‚ ID Р°РЅРёРњРµ',
        'any.required': 'ID Р°РЅРёРњРµ РѕР±СЏР·Р°С‚РµР»РµРЅ'
      }),
